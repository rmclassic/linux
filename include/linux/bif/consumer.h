...
int bif_ctrl_bus_lock(struct bif_ctrl *ctrl);
int bif_ctrl_bus_unlock(struct bif_ctrl *ctrl);
...
static inline int bif_ctrl_bus_lock(struct bif_ctrl *ctrl)
{ return -EPERM; }
static inline int bif_ctrl_bus_unlock(struct bif_ctrl *ctrl)
{ return -EPERM; }
